...
class TipCalculator():
    def __init__(self):
        ...
        tip_percents.grid(column=0,row=0,padx=15,pady=14)
        ...
        one_percent_tip= Radiobutton(window,text="1%",variable=self.tip_percent,value=1)
        one_percent_tip.grid(column=0,row=1)
